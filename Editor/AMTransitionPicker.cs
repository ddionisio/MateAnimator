...
namespace M8.Animator {
	public class AMTransitionPicker : EditorWindow {
	    ...
	    public static int[] TransitionOrder = new int[]{
			(int)AMCameraSwitcherKey.Fade.None,
			(int)AMCameraSwitcherKey.Fade.CrossFade,
			(int)AMCameraSwitcherKey.Fade.Doors,
			(int)AMCameraSwitcherKey.Fade.VenetianBlinds,
			(int)AMCameraSwitcherKey.Fade.IrisBox,
			(int)AMCameraSwitcherKey.Fade.IrisRound,
			(int)AMCameraSwitcherKey.Fade.IrisShape,
			(int)AMCameraSwitcherKey.Fade.LinearWipe,
			(int)AMCameraSwitcherKey.Fade.ShapeWipe,
			(int)AMCameraSwitcherKey.Fade.RadialWipe,
			(int)AMCameraSwitcherKey.Fade.WedgeWipe
	   ...
	   // private Texture texLeftArrow;	// inspector left arrow
	    ...
	    void OnGUI() {
	        ...
	        if(selectedTransition == (int)AMCameraSwitcherKey.Fade.None) {
	    ...
	    public void setParametersFor(int index) {
	        ...
	        switch(index) {
	            ...
	            case (int)AMCameraSwitcherKey.Fade.VenetianBlinds:
	            ...
	            #endregion
	            #region shape wipe
	            case (int)AMCameraSwitcherKey.Fade.ShapeWipe:
	                // angle
	            ...
	            #endregion
	            #region linear wipe
	            case (int)AMCameraSwitcherKey.Fade.LinearWipe:
	                // angle
	            ...
	            #endregion
	            #region radial wipe
	            case (int)AMCameraSwitcherKey.Fade.RadialWipe:
	            ...
	            #endregion
	            #region wedge wipe
	            case (int)AMCameraSwitcherKey.Fade.WedgeWipe:
	                GUILayout.Space(3f);
	                // starting angle
