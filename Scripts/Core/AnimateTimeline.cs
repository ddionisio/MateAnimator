...
namespace M8.Animator {
    /// <summary>
    /// Animator timeline.  Use for interacting with a global animator data.  Make sure to set 'global' to true in Animate.
    /// </summary>
    public class AnimateTimeline {
        #region Runtime
        private static Animate mAnim;

        public static Animate animator {
            get {
                if(mAnim == null) {
                    Animate[] anims = UnityEngine.Object.FindObjectsOfType<Animate>();
                    ...
                    if(mAnim == null && anims.Length > 0)
                        ...
                        Debug.LogError("No Animate in scene");
                    }
                }
        ...
        private static void setupHashEase(Hashtable hashTable, AnimateTimeline.JSONAction a) {
