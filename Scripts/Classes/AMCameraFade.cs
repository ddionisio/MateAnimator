...
public class AMCameraFade : MonoBehaviour {
    ...
    // =======================
    // Add Transition to AMCameraSwitcherKey.Fade Enum & AMTween.TransitionNamesDict; Add to ordered arrays for Transition Picker: AMTween.TransitionNames, AMTween.TransitionOrder
